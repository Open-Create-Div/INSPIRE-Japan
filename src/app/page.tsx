      ...
      <header className="bg-[#E5F6FF] py-1 sm:py-2">
        <div className="container mx-auto flex flex-row items-center justify-between pl-0 pr-1 xs:pl-0 xs:pr-2 sm:pl-1 sm:pr-3 md:px-4 scale-[0.82] xs:scale-[0.85] sm:scale-90 md:scale-95 lg:scale-100 gap-1 xs:gap-1.5 sm:gap-2 md:gap-3">
          ...
          <div className="hidden lg:flex flex-col items-center">
            <span className="text-[10px] xs:text-xs sm:text-sm whitespace-nowrap text-gray-700">各種お支払いに対応</span>
            <div className="flex items-center gap-1">
              <Image src="/images/visa.webp" alt="VISA" width={24} height={24} className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" />
              <Image src="/images/mastercard.webp" alt="MasterCard" width={24} height={24} className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" />
              <Image src="/images/jcb.webp" alt="JCB" width={24} height={24} className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" />
              <Image src="/images/amex.webp" alt="American Express" width={24} height={24} className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" />
              <Image src="/images/diners.webp" alt="Diners Club" width={24} height={24} className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" />
              <Image src="/images/paypay.webp" alt="PayPay" width={24} height={24} className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" />
            </div>
          </div>

          {/* 見積無料バッジ */}
          <div className="hidden md:flex items-center ml-2 xs:ml-3 sm:ml-4">
            <span className="inline-flex flex-col items-center justify-center px-1.5 xs:px-2 sm:px-3 py-0.5 xs:py-1 sm:py-2 text-orange-500 font-bold text-[8px] xs:text-[10px] sm:text-xs md:text-sm lg:text-base border-2 border-orange-500 rounded-full bg-white relative shadow whitespace-nowrap aspect-square">
              <span>見積</span>
              <span>無料</span>
          ...
          <div className="flex flex-col items-center">
            <a href="tel:0120-488-895" className="flex flex-col items-center shine-effect transform hover:scale-105 transition-all duration-300">
              <span className="text-[8px] xs:text-[10px] sm:text-xs whitespace-nowrap">受付時間9:00～19:00</span>
              <div className="flex items-center justify-center">
                <span className="text-green-600 font-bold text-[10px] xs:text-xs sm:text-sm md:text-base whitespace-nowrap hover:text-green-700 transition-colors">
                  <span className="inline-block align-middle">☎</span>0120-488-895
                </span>
              </div>
              <span className="text-[8px] xs:text-[10px] sm:text-xs whitespace-nowrap">お電話でのご相談はこちら</span>
            </a>
          </div>
          ...
          <div className="flex flex-row items-center gap-1 xs:gap-2 sm:gap-3">
              ...
              <div className="flex items-center gap-1 xs:gap-2 w-full">
                ...
                <div className="flex flex-col items-start flex-1">
                  <div className="flex items-center">
                    <span className="text-sm xs:text-base sm:text-lg font-bold whitespace-nowrap">無料相談</span>
                    <span className="text-[8px] xs:text-[10px] sm:text-xs whitespace-nowrap ml-1">はこちら</span>
                  </div>
            ...
            <a href="https://lin.ee/xOGQHrD" target="_blank" rel="noopener noreferrer" 
              ...
              <div className="flex items-center gap-1 xs:gap-2 w-full">
                <Image src="/images/line-icon.webp" alt="LINEアイコン" width={24} height={24} className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 -ml-1.5" />
                <div className="flex flex-col items-start flex-1">
                  <div className="flex items-center">
                    <span className="text-sm xs:text-base sm:text-lg font-bold whitespace-nowrap">LINE相談</span>
                    <span className="text-[8px] xs:text-[10px] sm:text-xs whitespace-nowrap ml-1">はこちら</span>
                  </div>
                  <span className="text-[8px] xs:text-[10px] sm:text-xs whitespace-nowrap text-center w-full">24時間受付</span>
                </div>
