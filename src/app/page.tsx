...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* ヘッダーセクション */}
      <header className="bg-[#E5F6FF] py-1 sm:py-2">
        <div className="container mx-auto flex flex-row items-center justify-center sm:justify-between px-2 sm:px-3 md:px-4 scale-[0.85] xs:scale-[0.9] sm:scale-95 md:scale-100 gap-1 sm:gap-2 md:gap-3">
          {/* ロゴ・会社名（常に表示） */}
          <div className="flex flex-col items-center min-w-[80px] xs:min-w-[90px] sm:min-w-[100px]">
            <span className="text-[9px] xs:text-[10px] sm:text-sm md:text-sm whitespace-nowrap text-gray-700">遮熱フィルムの貼付なら</span>
            <Image src="/images/logo.webp" alt="NH本舗" width={120} height={40} className="w-18 xs:w-20 sm:w-28 md:w-36 h-auto" />
          </div>

          {/* 決済手段アイコン＋ラベル */}
          <div className="hidden lg:flex flex-col items-center">
            <span className="text-[10px] sm:text-sm whitespace-nowrap text-gray-700">各種お支払いに対応</span>
            <div className="flex items-center gap-1">
              <Image src="/images/visa.webp" alt="VISA" width={24} height={24} className="w-4 h-4 sm:w-6 sm:h-6" />
              <Image src="/images/mastercard.webp" alt="MasterCard" width={24} height={24} className="w-4 h-4 sm:w-6 sm:h-6" />
              <Image src="/images/jcb.webp" alt="JCB" width={24} height={24} className="w-4 h-4 sm:w-6 sm:h-6" />
              <Image src="/images/amex.webp" alt="American Express" width={24} height={24} className="w-4 h-4 sm:w-6 sm:h-6" />
              <Image src="/images/diners.webp" alt="Diners Club" width={24} height={24} className="w-4 h-4 sm:w-6 sm:h-6" />
              <Image src="/images/paypay.webp" alt="PayPay" width={24} height={24} className="w-4 h-4 sm:w-6 sm:h-6" />
            </div>
          </div>

          {/* 見積無料バッジ */}
          <div className="hidden md:flex items-center">
            <span className="inline-flex flex-col items-center justify-center px-2 sm:px-3 py-1 sm:py-2 text-orange-500 font-bold text-[9px] xs:text-[10px] sm:text-xs md:text-sm lg:text-base border-2 border-orange-500 rounded-full bg-white relative shadow whitespace-nowrap aspect-square">
              <span>見積</span>
              <span>無料</span>
              <span className="absolute -right-2 top-1/2 -translate-y-1/2 w-0 h-0 border-t-[6px] border-b-[6px] border-l-[6px] border-t-transparent border-b-transparent border-l-orange-500"></span>
            </span>
          </div>

          {/* 電話番号・受付時間 */}
          <div className="hidden sm:flex flex-col items-center min-w-[70px] xs:min-w-[80px] sm:min-w-[100px]">
            <a href="tel:0120-488-895" className="flex flex-col items-center shine-effect transform hover:scale-105 transition-all duration-300">
              <span className="text-[7px] xs:text-[8px] sm:text-xs whitespace-nowrap">受付時間9:00～19:00</span>
              <div className="flex items-center justify-center">
                <span className="text-green-600 font-bold text-[9px] xs:text-[10px] sm:text-sm md:text-base whitespace-nowrap hover:text-green-700 transition-colors">
                  <span className="inline-block align-middle">☎</span>0120-488-895
                </span>
              </div>
              <span className="text-[7px] xs:text-[8px] sm:text-xs whitespace-nowrap">お電話でのご相談はこちら</span>
            </a>
          </div>

          {/* 相談ボタン */}
          <div className="hidden sm:flex flex-row items-center gap-1 sm:gap-2">
            <button onClick={scrollToContactForm} className="bg-gradient-to-b from-[#4DB5E8] via-[#00A0E9] to-[#0090D9] text-white px-2 xs:px-2.5 sm:px-3 py-1 xs:py-1.5 sm:py-2 rounded font-bold flex flex-col items-center min-w-[90px] xs:min-w-[100px] sm:min-w-[120px] shine-effect transform hover:scale-105 transition-all duration-300 hover:brightness-110">
              <div className="flex items-center gap-1 sm:gap-2 w-full">
                <span className="text-sm xs:text-base sm:text-xl -ml-1">✉</span>
                <div className="flex flex-col items-start flex-1">
                  <div className="flex items-center">
                    <span className="text-[11px] xs:text-[12px] sm:text-base font-bold whitespace-nowrap">無料相談</span>
                    <span className="text-[7px] xs:text-[8px] sm:text-[10px] whitespace-nowrap ml-1">はこちら</span>
                  </div>
                  <span className="text-[7px] xs:text-[8px] sm:text-[10px] whitespace-nowrap text-center w-full">24時間受付</span>
                </div>
              </div>
            </button>
            <a href="https://lin.ee/xOGQHrD" target="_blank" rel="noopener noreferrer" 
               className="bg-gradient-to-b from-green-400 via-green-500 to-green-600 text-white px-2 xs:px-2.5 sm:px-3 py-1 xs:py-1.5 sm:py-2 rounded font-bold flex flex-col items-center min-w-[90px] xs:min-w-[100px] sm:min-w-[120px] shine-effect transform hover:scale-105 transition-all duration-300 hover:brightness-110">
              <div className="flex items-center gap-1 sm:gap-2 w-full">
                <Image src="/images/line-icon.webp" alt="LINEアイコン" width={24} height={24} className="w-4 h-4 xs:w-4.5 xs:h-4.5 sm:w-5 sm:h-5 -ml-1" />
                <div className="flex flex-col items-start flex-1">
                  <div className="flex items-center">
                    <span className="text-[11px] xs:text-[12px] sm:text-base font-bold whitespace-nowrap">LINE相談</span>
                    <span className="text-[7px] xs:text-[8px] sm:text-[10px] whitespace-nowrap ml-1">はこちら</span>
                  </div>
                  <span className="text-[7px] xs:text-[8px] sm:text-[10px] whitespace-nowrap text-center w-full">24時間受付</span>
                </div>
      ...
      {/* スマホ用フッター */}
      <div className="fixed bottom-0 left-0 right-0 bg-[#E5F6FF]/90 backdrop-blur-sm py-1 sm:hidden z-50">
        <div className="container mx-auto flex flex-row items-center justify-center gap-1">
          {/* 電話番号 */}
          <a href="tel:0120-488-895" className="flex flex-col items-center shine-effect transform hover:scale-105 transition-all duration-300">
            <div className="flex items-center justify-center">
              <span className="text-green-600 font-bold text-sm whitespace-nowrap hover:text-green-700 transition-colors">
                <span className="inline-block align-middle">☎</span>0120-488-895
              </span>
            </div>
            <span className="text-[8px] whitespace-nowrap">受付時間9:00～19:00</span>
          </a>

          {/* 相談ボタン */}
          <button onClick={scrollToContactForm} className="bg-gradient-to-b from-[#4DB5E8] via-[#00A0E9] to-[#0090D9] text-white px-1.5 py-0.5 rounded font-bold flex flex-col items-center min-w-[80px] shine-effect transform hover:scale-105 transition-all duration-300 hover:brightness-110">
            <div className="flex items-center gap-0.5 w-full">
              <span className="text-sm">✉</span>
              <div className="flex flex-col items-start flex-1">
                <div className="flex items-center">
                  <span className="text-[10px] font-bold whitespace-nowrap">無料相談</span>
                  <span className="text-[7px] whitespace-nowrap ml-0.5">はこちら</span>
                </div>
                <span className="text-[7px] whitespace-nowrap text-center w-full">24時間受付</span>
              </div>
            </div>
          </button>
          ...
          {/* LINEボタン */}
          <a href="https://lin.ee/xOGQHrD" target="_blank" rel="noopener noreferrer" 
             className="bg-gradient-to-b from-green-400 via-green-500 to-green-600 text-white px-1.5 py-0.5 rounded font-bold flex flex-col items-center min-w-[80px] shine-effect transform hover:scale-105 transition-all duration-300 hover:brightness-110">
            <div className="flex items-center gap-0.5 w-full">
              <Image src="/images/line-icon.webp" alt="LINEアイコン" width={24} height={24} className="w-3.5 h-3.5" />
              <div className="flex flex-col items-start flex-1">
                <div className="flex items-center">
                  <span className="text-[10px] font-bold whitespace-nowrap">LINE相談</span>
                  <span className="text-[7px] whitespace-nowrap ml-0.5">はこちら</span>
                </div>
                <span className="text-[7px] whitespace-nowrap text-center w-full">24時間受付</span>
              </div>
